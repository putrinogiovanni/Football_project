...
st.markdown(
    ...
    ### In case you want to learn more about the technical work behind it see this link https://github.com/putrinogiovanni/Football_project/blob/main/Clustering_and_scraping/final.ipynb .\n
